...
L.PathTransform.RotateHandle2 = L.CircleMarker.extend({
  options: {
    className: 'leaflet-path-transform-handler transform-handler--rotate'
  },
...
L.Handler.PathTransform = L.Handler.extend({
  ...
  options: {
    ...
    rotateHandleClass: L.PathTransform.RotateHandle2
  },
  ...
  _createRotationHandlers: function() {
    ...
    // console.log(RotateHandleClass.getLatLng());

    this._handlers.push(this._rotationMarker);

    // var marker = L.marker(topPoint).addTo(map);
  },
  ...
  _onScale: function(evt) {
    ...
    if (this.options.uniformScaling) {
      ...
      // console.log("evt.layerPoint=", evt.layerPoint);
      // console.log("this._initialDistX=", this._initialDistX);
      // console.log("this._initialDistY=", this._initialDistY);
